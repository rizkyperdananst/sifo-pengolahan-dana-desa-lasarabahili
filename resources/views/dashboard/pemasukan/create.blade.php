...
@section('title', 'Admin | Tambah Pemasukan')
                    ...
                    <form action="{{ route('pemasukan.store') }}" method="POST">
                         ...
                         <div class="row mb-3">
                              ...
                              <div class="col-md-6">
                                   ...
                                   <input type="number" name="pemasukan" id="pemasukan" class="form-control @error('pemasukan') is-invalid @enderror" placeholder="masukkan pemasukan">
                                   @error('pemasukan')
                                       <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                   @enderror
                              </div>
